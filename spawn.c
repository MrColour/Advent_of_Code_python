...
/*   Updated: 2020/11/23 13:18:00 by home             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	make_day(char *s_year, char *s_day)
{
	...
	assert(2015 < year && year <= 2019 && "Year argument is out of bounds. Valid range is [2015, 2019]");
	...
	asprintf(&p1_str, "p_%d_%02d_01.py", year, day);
	asprintf(&p2_str, "p_%d_%02d_02.py", year, day);
